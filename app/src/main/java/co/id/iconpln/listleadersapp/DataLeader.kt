...
object DataLeader {
    ...
    val listDataWorldLeaders: ArrayList<ModelLeader>
        get() {
            // create empty List
            ...
            for(data in dataWorldLeaders) {
                ...
                leaders.share = data[3]
                leaders.photo = data[4]
                list.add(leaders)
            }
            return list
        }
    ...
    private var dataWorldLeaders = arrayOf(
        ...
        arrayOf(
            ...
            "Mexico",
            "https://id.wikipedia.org/wiki/Guadalupe_Victoria",
        ...
        arrayOf(
            ...
            "Washington",
            "https://id.wikipedia.org/wiki/Abraham_Lincoln",
